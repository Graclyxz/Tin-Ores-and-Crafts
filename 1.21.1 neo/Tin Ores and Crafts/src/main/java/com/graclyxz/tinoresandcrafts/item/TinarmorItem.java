...
public abstract class TinarmorItem extends ArmorItem {
	...
	public static void registerArmorMaterial(RegisterEvent event) {
		...
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			...
			), () -> Ingredient.of(new ItemStack(TinOresAndCraftsModItems.TININGOT.get())),
					List.of(new ArmorMaterial.Layer(ResourceLocation.parse("tin_ores_and_crafts:tin"))), 0f, 0f);
			registerHelper.register(ResourceLocation.parse("tin_ores_and_crafts:tinarmor"), armorMaterial);
